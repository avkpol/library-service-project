...
class CustomerTests(TestCase):
    ...
    def test_customer_registration(self):
        ...
        response = self.client.post('/api/users', data=self.user_data, format='json', follow=True)
    ...
    def test_customer_login(self):
        user = User.objects.create_user(**self.user_data)
        self.client.force_authenticate(user=user)
        response = self.client.post('/api/auth/', data={'email': self.user_data['email'], 'password': self.user_data['password']}, follow=True)
